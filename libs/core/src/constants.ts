...
export const VALIDATION_ERROR_KIND = {
  MISSING: 'MISSING',
  NON_APPLIED: 'NON_APPLIED',
  MISMATCH_ORDER: 'MISMATCH_ORDER',
  MISMATCH_CHECKSUM: 'MISMATCH_CHECKSUM',
} as const;

export type ERROR_KIND =
  (typeof VALIDATION_ERROR_KIND)[keyof typeof VALIDATION_ERROR_KIND];
